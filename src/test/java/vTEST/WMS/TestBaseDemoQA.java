...
public class TestBaseDemoQA {
	...
	public void Extentsetup() {
		...
		htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+"/test-output/WMS_ExtentReport26A4.html");
		...
		//prop.setProperty("C:\\Users\\naved\\eclipse-workspace\\WMS\\log4j.properties", "WARN");
	...
	public void afterMethod(ITestResult result) throws Exception{
		if(result.getStatus() == ITestResult.FAILURE){
			...
			String imagePath = TestBaseDemoQA.getSceenShot(driver, result.getName());
